        ...
        con.connect(function(err) {
            ...
            con.query(sql, function (err, result) 
            {
                if (err) throw err;
                    ...
                    res.render('viewAssigned_task',{'err' : '', tasks : result, fullName : req.session.fullName, is_admin : req.session.isAdmin})
                    con.end();
                }
            })        
        });     
