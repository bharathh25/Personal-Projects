        ...
        con.query(sql, function (err, result) 
        {
            ...
            con.query(sql1,function(err, result1)
            {
                ...
                if(result.length == 1) {
                    ...
                    if(result[0]["usersName_Users"]=='admin')
                        res.redirect('/administrator');
                    else if(result[0]["isAdmin_Users"]==1)
                        res.redirect('/cat_admin');
                    else
                    res.render('admin_login', {'err': 'Invalid username or password'})
